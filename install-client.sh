...
msg "Usted a Entrado Al Instalador de $OWNER_NAME.\n\n¿ Quieres Instalar El Slipstream-client ?"

confirm "Quieres Continuar Con El Proceso De Instalación Toque Enter"
[ $? -ne 0 ] && clear && exit 1
